...
A  _second screen/information radiator/glancable_ for a Last.fm users now-playing track forked from dsingleton.
...
* Near real time - It's polling, but it updates quickly.

"Read more":http://dsingleton.co.uk/blog/last-fm-now-playing-information-radiator about it or try the "demo":http://wisdomaws.linkpc.net/lastfm_nowplaying/index.html.

h2. Todo

Some small and large improvements I plan make, in rough order:

* Improve Artwork fetching
